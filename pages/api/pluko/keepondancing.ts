...
const songContractAddress = "0x229b1E21AD70ec7d1616100c18F365B7CaF6AB9d";
...
function successScreen(res: NextApiResponse) {
  const htmlContent = `
        ...
        <meta name="fc:frame:image" content=${endpointProd}/plukokeepondancing/success.png />
...
function alreadyMintedScreen(res: NextApiResponse) {
  const htmlContent = `
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="fc:frame" content="vNext" />
        <meta name="fc:frame:image" content=${endpointProd}/plukokeepondancing/alreadycollected.png />
        <meta name="og:image" content="op.png" />
      `;
  res.setHeader("Content-Type", "text/html");
...
function soldoutScreen(res: NextApiResponse) {
  const htmlContent = `
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="fc:frame" content="vNext" />
        <meta name="fc:frame:image" content=${endpointProd}/plukokeepondancing/soldout.png />
        <meta name="og:image" content="op.png" />
      `;
  res.setHeader("Content-Type", "text/html");
...
async function isFollowingCoopAndSound(fid: number): Promise<boolean> {
  return (
    (await isFollowingChannel(fid, "coop-recs")) &&
    (await isFollowingChannel(fid, "soundxyz"))
  );
}
