...
const songContractAddress = "0x450A8eFBCE7697FEDB5dB1000d88FCa3a36746e0";
...
export default async function handler(
  ...
  try {
    ...
    if (req.body.untrustedData.buttonIndex === 2) {
      ...
      res.redirect(302, "https://warpcast.com/cooprecs");
      res.statusCode = 302;
      res.setHeader("location", "https://warpcast.com/cooprecs");
      res.end();
    } else {
...
function successScreen(res: NextApiResponse) {
  const htmlContent = `
          ...
          <meta name="fc:frame:image" content=${endpointProd}/greysilverlinen/success.png />
...
function alreadyMintedScreen(res: NextApiResponse) {
  const htmlContent = `
          ...
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <meta name="fc:frame" content="vNext" />
          <meta name="fc:frame:image" content=${endpointProd}/greysilverlinen/alreadycollected.png />
          <meta name="og:image" content="op.png" />
        `;
  res.setHeader("Content-Type", "text/html");
...
function followScreen(res: NextApiResponse) {
  const htmlContent = `
            ...
            <meta name="viewport" content="width=device-width, initial-scale=1" />
            <meta name="fc:frame" content="vNext" />
            <meta name="fc:frame:image" content=${endpointProd}/greysilverlinen/follow.png />
...
function soldoutScreen(res: NextApiResponse) {
  const htmlContent = `
          ...
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <meta name="fc:frame" content="vNext" />
          <meta name="fc:frame:image" content=${endpointProd}/greysilverlinen/soldout.png />
          <meta name="og:image" content="op.png" />
        `;
  res.setHeader("Content-Type", "text/html");
...
async function isFollowingCoop(fid: number): Promise<boolean> {
  ...
  while (true) {
    const response = await fetch(
      `https://api.neynar.com/v1/farcaster/followers?fid=262450&viewerFid=3&limit=150${
