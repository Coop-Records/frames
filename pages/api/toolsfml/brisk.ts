...
const songContractAddress = "0x9D00DF8941c35132F8f21F311c3F6BB0920AF6C4";
...
function successScreen(res: NextApiResponse) {
  const htmlContent = `
            ...
            <meta name="fc:frame:image" content=${endpointProd}/toolsfmlbrisk/success.png />
...
function alreadyMintedScreen(res: NextApiResponse) {
  const htmlContent = `
            ...
            <meta name="viewport" content="width=device-width, initial-scale=1" />
            <meta name="fc:frame" content="vNext" />
            <meta name="fc:frame:image" content=${endpointProd}/toolsfmlbrisk/alreadycollected.png />
            <meta name="og:image" content="op.png" />
          `;
  res.setHeader("Content-Type", "text/html");
...
function followScreen(res: NextApiResponse) {
  const htmlContent = `
              ...
              <meta name="viewport" content="width=device-width, initial-scale=1" />
              <meta name="fc:frame" content="vNext" />
              <meta name="fc:frame:image" content=${endpointProd}/toolsfmlbrisk/follow.png />
...
function soldoutScreen(res: NextApiResponse) {
  const htmlContent = `
            ...
            <meta name="viewport" content="width=device-width, initial-scale=1" />
            <meta name="fc:frame" content="vNext" />
            <meta name="fc:frame:image" content=${endpointProd}/toolsfmlbrisk/soldout.png />
            <meta name="og:image" content="op.png" />
          `;
  res.setHeader("Content-Type", "text/html");
